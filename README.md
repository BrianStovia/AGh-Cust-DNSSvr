<h1 align="center">DNS SERVER BRST</h1>
<h3 align="center">High-Performance Custom DNS Server & Privacy Protection Center</h3>
<p align="center">
  Customized High-Speed DNS Server based on AdGuard Home, optimized for Debian-based Linux systems.
</p>
<p align="center">
  <a href="https://github.com/BrianStovia/AGh-Cust-DNSSvr">GitHub Repository</a> |
...
To install using the standard installer:

```sh
curl -s -S -L https://raw.githubusercontent.com/BrianStovia/AGh-Cust-DNSSvr/main/scripts/install.sh | sh -s -- -v
```
